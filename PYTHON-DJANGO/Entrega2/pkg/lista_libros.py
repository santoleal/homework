libros = [
...

  {
    ...
    "description": "Una interesante trama de misterios dentro de una mansión de un multimillonario.",
...

  {
    ...
    "description": "Fallaci reaparece tras años de silencio, para condenar los ataques a las torres de Nueva York del 11 de seprtiembre del 2001",
...

  {
    ...
    "author": "Osho",
    "description": "Osho responde a las preguntas que se le plantean sobre el tema de la mujer desde el punto de vista de la conciencia.",
...

  {
    ...
    "description": "Verás cómo la amistad es una de las cosas más poderosas del mundo.",
